...
function resizeSidebar(op) {
    ...
    if (op == "1") {
        ...
        $(".item.popupHover.displaynone").addClass("displayblock");
        ...
        $(".item.popupHover.displaynone").removeClass("displayblock");
...
$(document).ready(function() {
    ...
    $('.ui.embed').embed();
    //init popup
    let popupClass = document.querySelectorAll('.popupHover');
    $.each(popupClass,function (key,value) {
        $(value).popup();
    });
    //init img picker
